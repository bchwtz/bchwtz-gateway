...
class TemperatureSensor(Sensor):
    """An object of this class creates a digital representation of a temperature sensor. This sensor's measurements are of type gateway.sensor.temperature.TemperatureSensor.TemperatureMeasurement.
