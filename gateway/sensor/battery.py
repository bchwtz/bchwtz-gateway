...
class BatterySensor(Sensor):
    """An object of this class creates a digital representation of a battery sensor. This sensors measurements are of type gateway.sensor.battery.BatterySensor.BatteryMeasurement.
    """
    def __init__(self):
