class Config:
    ...
    class Commands:
        def __init__(self) -> None:
            ...
            self.activate_logging_at_sensor: str = "4a4a080100000000000000"
            self.deactivate_logging_at_sensor: str = "4a4a080000000000000000"
            self.get_acceleration_data: str = "4a4a110100000000000000"
            self.set_sensor_config_substr: str = "4a4a02"
            self.get_sensor_config: str = "4a4a030000000000000000"
            self.get_sensor_timestamp: str = "2121090000000000000000"
            self.set_sensor_time_substr: str = "212108"
