...
def get_tag_acceleration_data():
    """This demo shows how to get the acceleration_log from the tag.
    ...
    main_loop.run_until_complete(my_tag.get_flash_statistics())
    print("HEllo")

if __name__ == '__main__':
    get_tag_acceleration_data()
